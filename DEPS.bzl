...
def go_deps():
    ...
    go_repository(
        ...
        sum = "h1:ssMzja7PDPJV8FStj7hq9IKiuiKhgz9ErWw+m68e7DI=",
    ...
    go_repository(
        ...
        sum = "h1:w6WUp1VbkqPEgLz4rkBzH/CSU6HkoqNLp6GstyTx3lU=",
        version = "v0.7.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:2j8sInznrje4I0CMisSL6ipEBkeJUJAmK1/lfoNGWrQ=",
        version = "v0.1.7",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_adminbenni_iota_mixing",
        build_file_proto_mode = "disable_global",
        importpath = "github.com/AdminBenni/iota-mixing",
        sum = "h1:Os6lpjG2dp/AE5fYBPAA1zfa2qMdCAWwPMCgpwKq7wo=",
        version = "v1.0.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:nv2AVZdTyClGbVQkIzlDm/rnhk1E9bU9nXwmZ/Vk/iY=",
        version = "v2.23.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:cKGRBqlXw5iyQGLYhrXrDlcHxugXpTq4tQ5c91wkf8M=",
        version = "v1.1.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:HzTuoo2ErYQqf5qvcJInB8uvqSVxRttzkFexPWtnceM=",
        version = "v1.2.2",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:bllB7mlIbTVzO9jmSWVWLjxTEbGBVQ1Ff/ClQgtPw9Q=",
        version = "v1.1.1",
    )
    go_repository(
        ...
        sum = "h1:9Mdr6BYd8WHCDngQnNVV0b554xyisFioEKi30sksufQ=",
        version = "v1.1.1",
    )
    go_repository(
        ...
        sum = "h1:gs9fUEy+egzxkEbq9P4cpcMB6/G0DYdMeiFS87UiqmQ=",
        version = "v1.6.4",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:BxUaI96qgW9FzSrzbCmlnFvKOX/u7isAL6VrCWaVjEY=",
        version = "v18.6.1-0.20260713210906-efc145c067b6",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:OZZDOchCgsX5gvToVtEBoV2UWbFfI6RKQTir2UZzSxo=",
        version = "v2.3.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:snuKYMbqosNokUKm+R6/+vOPs8yVAi46La7Ck6QYSaE=",
        version = "v2.1.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:JXg2dwJUmPB9JmtVmdEB16APJ7jurfbY5jnfXpJoRMc=",
        version = "v1.20.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:/Zt+cDPnpC3OVDm/JKLOs7M2DKmLRIIp3XIx9pHHiig=",
        version = "v1.8.1",
    )
    go_repository(
        ...
        sum = "h1:ZJJNFaQ86GVKQ9ehwqyAFE6pIfyicpuJ8IkVaPBc6/4=",
        version = "v1.6.3",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:4z+/sBqC5vUmSp1O0mS+czxwH9+LKXtCWtHH9rZGQL8=",
        version = "v5.6.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:u7Riei30bk46XsG8nknMhKLXG9BcXz3+3tl/WpKm0PQ=",
        version = "v0.10.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:g1/EX1eIiKS57NTWsYtHDZ/APfeXKhye1DidBcABctk=",
        version = "v0.0.11",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:R0ymNeydRqH2DmakFNdmjR2k0t7UPuiOV/N/27/qqsc=",
        version = "v1.0.5",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:eHfopDqXRwAi+YmCUas75ZE0+hoBHJ2GQNLYRSxao4g=",
        version = "v0.1.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:QIw4xfpWT6GWTzaW5XEKy3HXoqrJGx1ijYHzTF0/ISU=",
        version = "v0.10.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:oW7OPFit2FxZOpmMRPP9FffU4uUpfeE/rEdE1f+MzD0=",
        version = "v0.3.20",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:5R1qH2iFeo4I/RJU8vTezdqs08Egi4u5p6vOESA0pog=",
        version = "v0.14.3",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_godoc_lint_godoc_lint",
        build_file_proto_mode = "disable_global",
        importpath = "github.com/godoc-lint/godoc-lint",
        sum = "h1:Bp0FkJWoSdNsBikdNgIcgtaoo+xz6I/Y9s5WSBQUeeM=",
        version = "v0.11.2",
    )
    go_repository(
        ...
        sum = "h1:95JolYOvGMqeH31+FC7D2+uULf6mG61mEZ/A8dRYMzw=",
        version = "v0.13.0",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_golangci_asciicheck",
        build_file_proto_mode = "disable_global",
        importpath = "github.com/golangci/asciicheck",
        sum = "h1:jczN/BorERZwK8oiFBOGvlGPknhvq0bjnysTj4nUfo0=",
        version = "v0.5.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:hIYTFJqAGp1iwoIfsNTpoq1xZAarogrvjO9AfiW3B4U=",
        version = "v0.1.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:ySX1GtLwlwOEzcLKJifI/aIVesrcHDno+5mrro8rWes=",
        version = "v2.11.3",
    )
    go_repository(
        ...
        sum = "h1:Qnph25g8Y1c5fdo1X7GaRDGgnMHgnxh4Gk4VfPTtRx0=",
        version = "v0.15.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:qvxQhiE2/5z+BVRo1kwYA8yGz+lOlu5Jfvtx2b04Jbg=",
        version = "v0.8.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:haMV2JRRJCe1998HeW/p0X9UaMTK6SDo0ffLn2+DbLs=",
    ...
    go_repository(
        ...
        sum = "h1:JjJXBTk1ETNyqyilJhkTXJYYigHG24TM9Xa2M1xAhRA=",
        version = "v1.6.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:Uths4KnmwxNJNzq87fwQQDDnbNb7De00VOk9Nu0TySs=",
        version = "v0.2.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:S6nk8a9N8g062nsx63kUkF6AzbHGw7zzyHMcpu52xQU=",
        version = "v0.1.2",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:wv3nmua7lCEIwWsb6vqsTS3pXktTxcKg5eoyNu0VhrU=",
        version = "v2.31.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:yfNQvP9YaGQR7VaWLYcfZUlRP2eo2vhExWKxD/fP6q0=",
        version = "v1.2.2",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:Lvs/YAHP24YKg08LA8oDw2z9fJVme090RAXd90S+rrw=",
        version = "v1.10.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:fI8QITAoFVLx+y+vSyuLBP+rcVIB8jKooNSCT2EiI98=",
        version = "v0.7.1",
    )
    go_repository(
        ...
        sum = "h1:ZMk4Qt306tHIgKISHWFJAO1IDQJLc6uDyJMLyncOb6w=",
        version = "v1.0.15",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:JqIuTtgvFC2RdH1s357vrE23WJF2cpDCPFgA/TWDGpk=",
        version = "v0.8.0",
    )
    go_repository(
        ...
        sum = "h1:keYi9rYsgbvqAZGI1liek5c+jv9UUjbvdj3Tbn5fn4o=",
        version = "v0.10.1",
    )
    go_repository(
        name = "com_github_ldez_structtags",
        build_file_proto_mode = "disable_global",
        importpath = "github.com/ldez/structtags",
        sum = "h1:bUooFLbXx41tW8SvkfwfFkkjPYvFFs59AAMgVg6DUBk=",
        version = "v0.6.1",
    )
    go_repository(
        ...
        sum = "h1:KuOlL70/fu9paxuxbeqlicJnCspCRjH0x8FW+NfgYUk=",
        version = "v0.7.2",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:3mAIyaGRtjK6EO9E73JlXLtiy7ha80b2ZVGyacxgfww=",
        version = "v0.4.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:HfOQXs+XgfeRBJ+Wz0XfH+FHnoY9TVqL6Fcevpzy4q8=",
        version = "v1.0.1",
    )
    go_repository(
        ...
        sum = "h1:ffDSh+AgqluCLMXhM19f/cpvQAKygKAJXFl9aUjmbqs=",
        version = "v1.1.2",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:WcT52H91ZUAwy8+HUkdM3THM6gXqXuLJi9O3rjcQQaQ=",
        version = "v0.0.20",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:vJ0HzSBzfNyPbHKolgiFjHxLek9KUijhqh42yGoqZ8Q=",
        version = "v1.15.0",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_mirrexone_unqueryvet",
        build_file_proto_mode = "disable_global",
        importpath = "github.com/MirrexOne/unqueryvet",
        sum = "h1:38QOxShO7JmMWT+eCdDMbcUgGCOeJphVkzzRgyLJgsQ=",
        version = "v1.5.4",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:x3o4DGYOWbBMP/VdNQKgSj+25aJKx2Pe6lHr8gBcgf8=",
        version = "v0.23.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:4ap5NsAa5AgJBom0lRKH4j+MI1m7E+zKNIE7LZ+n7XE=",
        version = "v0.11.5-0.20260508054701-306e305bcf41",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:10OHx2/2noFfPU1K3c3QXZshsw3XvKssk/mjbLdw8DI=",
        version = "v0.0.0-20260617071407-7c071244534b",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:ie+YmGmA727VuhxBlyGr74Ks+7McV6kT99IB8EU80aA=",
        version = "v0.12.83",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:AGY0tiOT5hJX9BTdx/xBdoCubQUAE2grkqY2lSwvZcA=",
        version = "v0.4.5",
    )
    go_repository(
        ...
        sum = "h1:lxjt5B6ZCiBeeNO8/oQsegE6fLeCzuMRoVWSkXC4uvY=",
        version = "v0.3.23",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:AoLtJX4WUtZkhhUUMFy3GgecAALp/Mb4S1iyQOA2s0U=",
    ...
    go_repository(
        ...
        sum = "h1:X8i6sicvUFih4BmYIGT1m2wwgw2VG9YgrDTi7cIRGUI=",
        version = "v4.26.2",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:e/jdaqAsuWVOKQ0P6NWiIdDNHmHT5SwuuSfojFjzwrw=",
        version = "v0.5.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:AyX7+dxI4IdLBPtDbsGAyqiTSLpCP9hWRrXQDU4Cm/g=",
        version = "v0.3.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:40rP4LejyK6SNQlWz7NX6kQELf8cmScWMBGruWhN4io=",
        version = "v0.87.0",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_substrait_io_substrait_go_v8",
        build_file_proto_mode = "disable_global",
        importpath = "github.com/substrait-io/substrait-go/v8",
        sum = "h1:XL7CqVVOQkXP9FRSIm2ylJCjqRASg1yBRcn5nRCRwss=",
        version = "v8.1.1",
    )
    go_repository(
        name = "com_github_substrait_io_substrait_protobuf_go",
        build_file_proto_mode = "disable_global",
        importpath = "github.com/substrait-io/substrait-protobuf/go",
        sum = "h1:zk6MtNWLtDSl8a7qCZRFH0+EIIXVrrd/hsgYK/SQTgM=",
        version = "v0.85.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:u1ww+gqpRLiIA16yF2PV1CV1n/X3zhyezbNXC3E14Sg=",
        version = "v1.5.4",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:frioLaCQSsF5Cy1jgRBrzr6t502KIIwQ0MArYICU0nA=",
        version = "v0.3.16",
    )
    go_repository(
        ...
        sum = "h1:nSTwhKH5e1dMNsCdVBukSZrURJRoHbSEQjdEbY+9RXw=",
        version = "v0.11.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:H/qQ1aNWz/eeIhxKAFvkfIA+N7YDvq6TWVFL27Of9is=",
        version = "v2.12.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:CSJynt5txTnORn/DkhiB4mZjwPuifyASC8/6Q0I/QS4=",
        version = "v1.2.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:xSCZjRoS93nXazBSg5d0OGCi9APPLNMmmLrC995tR50=",
        version = "v0.4.0",
    )
    go_repository(
        ...
        sum = "h1:Gt5jGD4Zcj8CDMVzjOJITlSb9cEch54hjRRlN3qDojE=",
        version = "v0.9.0",
    )
    go_repository(
    ...
    go_repository(
        name = "org_codeberg_polyfloyd_go_errorlint",
        build_file_proto_mode = "disable_global",
        importpath = "codeberg.org/polyfloyd/go-errorlint",
        sum = "h1:VkdEEmA1VBpH6ecQoMR4LdphVI3fA4RrCh2an7YmodI=",
        version = "v1.9.0",
    )
    go_repository(
        name = "org_gioui",
    ...
    go_repository(
        ...
        sum = "h1:XGySZATqQYSEV3/YTy+iX+aofbZZllJaqwFWs+RTtSo=",
        version = "v0.14.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:2u1hni3E+UXAXrONrrkfWpi/V6cyKVAbfGVeGtC3OxM=",
        version = "v0.230.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:Z/6YuSHTLOHfNFdb8zVZomZr7cqNgTJvA8+Qz75D8gU=",
    ...
    go_repository(
        ...
        sum = "h1:qWFG1Dj7TBjOjOvhEOkmyGPVoquqUKnIU0lEVLp8xyk=",
    ...
    go_repository(
        ...
        sum = "h1:+ra4Ui8ngyt8HDcO1FTDPWlkAh6yOdaO2yAoh8MddQA=",
        version = "v1.73.4",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:20WG8N9q4ji/dEqGk4uiI0c6OPjSeLTNYGFCc3+7c1M=",
        version = "v1.53.0",
    )
    go_repository(
